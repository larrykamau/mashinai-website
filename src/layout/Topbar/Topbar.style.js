...
export const AlertDot = styled.div(({ theme }) => ({
  color: get(theme, "colors.primary.light"),
  position: "absolute",
  top: "-4px",
  right: "-2px",
  display: "flex",
...
export const TopbarWrapper = styled.div(({ theme }) => ({
  ...
  padding: "30px 60px",
  boxShadow: get(theme, "colors.shadows.header"),
  position: "relative",
...
export const TopbarRightSide = styled.div(({ theme }) => ({
  display: "flex",
  alignItems: "center",
}));
...
export const UserDropdowItem = styled.div(({ theme }) => ({
  display: "flex",
...
export const NavLink = styled(RRNavLink, ({ theme }) => ({
  ...
  margin: "0",
  padding: "16px 20px",
  borderBottom: `1px solid ${get(theme, "colors.gray.200")}`,
